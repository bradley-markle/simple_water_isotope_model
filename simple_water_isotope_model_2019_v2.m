function [T_site, T_source, RH_source, d18O_site, dD_site, d18Oln_site, dDln_site, dxs_site, d17O_xs_site, dlnU_site, r_s_site, P_site] = simple_water_isotope_model_2019_v2(Tsite, Tsource, RHsource, P_s, closure, reanalysis, SH, season)
% BRM March 2017
...
clear d18O_p dD_p d17O_p d18O_p_ln dD_p_ln d17O_p_ln dxs dxs_ln T S ss d17O_xs model_dln_U %model_dln_2 model_dln_3 model_dln_2plus model_dln_3plus 
    end
end
end
...
clear d18O_p dD_p d17O_p d18O_p_ln dD_p_ln d17O_p_ln dxs dxs_ln T S ss d17O_xs model_dln_U r_s%model_dln_2 model_dln_3 model_dln_2plus model_dln_3plus 
        end
    end
end
end
