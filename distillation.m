function [d18O_p, dD_p, d17O_p, d18O_p_ln, dD_p_ln, d17O_p_ln, dxs, dxs_ln, d17Oxs, T, S, supersat, r_s] = distillation(T0, T_end, dT, dD_v0, d18O_v0, d17Oxs_v0, RHn0, rh0, sst0, a, b, c, pathway)
% BRM March 2017
% [d18O_p, dD_p, d17O_p, d18O_p_ln, dD_p_ln, d17O_p_ln, dxs, dxs_ln, d17Oxs, T, S, supersat, r_s] = distillation_model(T0, T_end, dT, dD_v0, d18O_v0, d17Oxs_v0, RHn0, rh0, sst0, a, b, c, pathway)
...
%this version cools the parcel from the original rh0 to saturationx
% [f, P, e_s, r_s, dPdT,ss] = pseudo_adiabat_function_rh0(T,P0,rh0,fraction_i, fraction_l,supersat,a,b,c);
