function [dD_v0, d18O_v0, d17Oxs_v0,RHn0,rh0,sst0] =evaporation_2020(T0,SST0,RH0,closure,reanalysis, SH, season, sw, alpha, unc)
% BRM March 2017: 
...
% 
%     end
[rh0, delta_rh0, sst0, delta_sst0, RHn0, deltarhn0] = T_RH_RHn_2020(T0, SH, reanalysis, 'spline', season, 0);
...
%     end
    [rh0, delta_rh0, ~, ~, RHn0, deltarhn0] = T_RH_RHn_2020(T0, SH, reanalysis, 'spline', season, 0);
...
%     end
    [~, ~, sst0, delta_sst0,~, ~] = T_RH_RHn_2020(T0, SH, reanalysis, 'spline', season, 0);
...
%   Option 4) a_diff use values from Luz, and Barkan, 2009
