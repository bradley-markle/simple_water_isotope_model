function [dD_v0, d18O_v0, d17Oxs_v0,RHn0,rh0,sst0] =evaporation_sw(T0,SST0,RH0,closure,reanalysis, SH, season, sw)
% BRM March 2017: 
...
% d18O_ocean=-1;
d18O_ocean=sw; %delta 18O value of Southern Ocean, from http://data.giss.nasa.gov/o18data/
...
% %%---turn on/off here
% aD_evap0=interpPH([0 10 20 100]',crissTable4_2(:,1),T); %from Criss Table 4.2
% a18O_evap0=interpPH([0 10 20 100]',crissTable4_2(:,2),T);%from Criss Table 4.2
% 
...
a18O_diff=1.009;%from Uemura 2010 optimized for dxs
