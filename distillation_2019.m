function [d18O_p, dD_p, d17O_p, d18O_p_ln, dD_p_ln, d17O_p_ln, dxs, dxs_ln, d17Oxs, T, S, supersat, r_s, e_s, f, P, rh, RD_c, RD_p, R18O_c, R18O_p, R17O_c, R17O_p] = distillation_2019(T0, T_end, dT, dD_v0, d18O_v0, d17Oxs_v0, RHn0, rh0, sst0, P_s, pathway)
...
% fraction_i=zeros(size(T));fraction_i(T<=-0)=1;
% fraction_l=zeros(size(T));fraction_l(T>-0)=1;

% method = 'adj';
% [fraction_i, fraction_l] = fraction_il_brm_H10(T-5,method);%this uses polynomial fits based on sattelite data.
% clear method
...
%this RH.(initSat)
[f, P, e_s, r_s, dPdT,ss] = pseudo_adiabat_function(T,P0,fraction_i, fraction_l,supersat,a,b,c);
rh=1.*ones(size(r_s));
% [f, P, e_s, r_s, dPdT,ss] = pseudo_adiabat_function2(T,P0,fraction_i, fraction_l,supersat,P_s);
% rh=1.*ones(size(r_s));
...
% [f, P, e_s, r_s, dPdT,ss,rh] = pseudo_adiabat_function_rh0_alt2(T,P0,rh0,fraction_i, fraction_l,supersat,P_s,RH_in);
