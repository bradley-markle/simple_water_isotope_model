function [dD_v0, d18O_v0, d17Oxs_v0,RHn0,rh0,sst0] =evaporation_2021(T0,SST0,RH0,closure,reanalysis, SH, season, sw, alpha, unc)
% BRM March 2017: 
...
% %Option 4b)
% N=0.301;%equivalent-ish to a18O_diff=1.009
% N=0.304;
N=0.302;
