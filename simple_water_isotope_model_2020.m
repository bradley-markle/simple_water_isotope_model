function [T_site, T_source, RH_source, d18O_site, dD_site, d18Oln_site, dDln_site, dxs_site, d17O_xs_site, dlnU_site, r_s_site, P_site] = simple_water_isotope_model_2020(Tsite, Tsource, RHsource, a, b, c, closure, reanalysis, SH, season)
% BRM March 2017
...
%         [dD_v0, d18O_v0, d17Oxs_v0,RHn0,rh0,sst0] = evaporation_2020(T0,SST0,RH0,closure,reanalysis, SH,season);
        [dD_v0, d18O_v0, d17Oxs_v0,RHn0,rh0,sst0] = evaporation_2021(T0,SST0,RH0,closure,reanalysis, SH,season);
...
%         [d18O_p, dD_p, d17O_p, d18O_p_ln, dD_p_ln, d17O_p_ln, dxs, dxs_ln, d17Oxs, T, S, supersat, r_s, e_s, f, P] = distillation_2019(T0, T_end, dT, dD_v0, d18O_v0, d17Oxs_v0, RHn0, rh0, sst0, P_s, pathway);
        [d18O_p, dD_p, d17O_p, d18O_p_ln, dD_p_ln, d17O_p_ln, dxs, dxs_ln, d17Oxs, T, S, supersat, r_s, e_s, f, P] = distillation_2020(T0, T_end, dT, dD_v0, d18O_v0, d17Oxs_v0, RHn0, rh0, sst0, a, b, c,pathway);
%         [d18O_p, dD_p, d17O_p, d18O_p_ln, dD_p_ln, d17O_p_ln, dxs, dxs_ln, d17Oxs, T, S, supersat, r_s, e_s, f, P] = distillation_2022(T0, T_end, dT, dD_v0, d18O_v0, d17Oxs_v0, RHn0, rh0, sst0, a, b, c,pathway);
